...
// Mono Contrast Preloader: a crushed black-and-white grade over archival footage.
...
export type MonoContrastShaderPreset =
  | "cinema"
  | "chroma"
  | "highcontrast"
  | "subtle"
...
export interface MonoContrastGrade {
...
const PRESETS: Record<Exclude<MonoContrastShaderPreset, "off">, MonoContrastGrade> = {
...
export interface MonoContrastPreloaderProps {
  ...
  shaderPreset?: MonoContrastShaderPreset
  /** Per-knob overrides layered on top of shaderPreset */
  grade?: Partial<MonoContrastGrade>
  /**
...
export default function MonoContrastPreloader({
  children,
  word = "ARCHIVE",
  ...
  const resolvedGrade = React.useMemo<MonoContrastGrade>(
