...
// Cinema Grain Preloader: film grain and CRT scanlines over a cinematic reel.
...
export type CinemaGrainShaderPreset =
  | "cinema"
  | "chroma"
  | "highcontrast"
  | "subtle"
...
export interface CinemaGrainGrade {
...
const PRESETS: Record<Exclude<CinemaGrainShaderPreset, "off">, CinemaGrainGrade> = {
...
export interface CinemaGrainPreloaderProps {
  ...
  shaderPreset?: CinemaGrainShaderPreset
  /** Per-knob overrides layered on top of shaderPreset */
  grade?: Partial<CinemaGrainGrade>
  /**
...
export default function CinemaGrainPreloader({
  children,
  word = "LOADER",
  ...
  const resolvedGrade = React.useMemo<CinemaGrainGrade>(
