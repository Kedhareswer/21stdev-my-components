# Cinema Grain Preloader

Film grain, soft CRT scanlines and a gentle 1.4x contrast lift over a cinematic reel.
...
```tsx
import CinemaGrainPreloader from "@/components/ui/cinema-grain-preloader"

// Looping loader, nothing else on screen
<CinemaGrainPreloader loop />

// Page gate: lifts to reveal children
<CinemaGrainPreloader word="LOADER" videoSrc="/reel.mp4" onComplete={() => {}}>
  <YourPage />
</CinemaGrainPreloader>
```
...
| `shaderPreset` | `"cinema"` |
| `word` | `"LOADER"` |
| `videoSrc` | `tears-of-steel-battle-clip-medium.mp4` (MDN shared-assets, CORS-enabled, openly licensed) |
